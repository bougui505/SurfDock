...
if __name__ == "__main__":
    ...
    parser.add_argument('--dist_threshold', type=float, default=8.0, help='Distance threshold for pocket extraction (default: 8.0)')
    ...
    results = Parallel(n_jobs = args.n_jobs,backend = 'multiprocessing')(delayed(compute_inp_surface)(target_filename, ligand_filename,args.out_dir, dist_threshold=args.dist_threshold) for (target_filename, ligand_filename) in tqdm(args_list))
    # print(results)
